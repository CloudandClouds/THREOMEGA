...
import { CheckCircle2, CreditCard, Headphones, Heart, Package, Truck, Star, Quote, ShieldCheck, UserCheck, TrendingDown } from 'lucide-react';
    ...
    const testimonials = [
        {
            ...
            quote: "The peace of mind I've gained since starting ThreOmega™ is invaluable. My energy levels have stabilized, and my medical team noted significant improvements in my CV markers.",
        ...
        },
        {
            ...
            quote: "The ThreOmega protocol aligns perfectly with the PISCES-HD findings. It provides the precise EPA/DHA ratio required for dialysis-specific cardiac protection.",
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                        ...
                        <div className="lg:col-span-5">
                            <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-6">
                                ...
                                <span className="text-white/70 font-black tracking-[0.2em] text-[10px] uppercase">Clinical Outcomes</span>
                            </div>
                            <h2 className="text-5xl md:text-6xl font-black text-white leading-tight mb-6" style={{ fontFamily: 'serif' }}>
                                Voices of <br /><span className="text-[#D4AF37]">Recovery.</span>
                            </h2>
                        ...
                        <div className="lg:col-span-7 flex flex-col gap-4">
                            {testimonials.map((t, i) => (
                                <div key={i} className="group relative bg-white/5 border border-white/10 rounded-[40px] p-8 overflow-hidden transition-all duration-500 hover:bg-white/10">
                                        ...
                                        <div className="flex-grow">
                                            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-4">
                                                <div>
                                                    ...
                                                    <p className="text-[#D4AF37] text-[10px] font-black uppercase tracking-widest">{t.history}</p>
                                                </div>
            ...
            <div className="py-32 px-6 bg-white">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-24">
                        <h2 className="text-5xl md:text-7xl font-black text-gray-900 mb-8 leading-[0.9]" style={{ fontFamily: 'serif' }}>
                            Clinical <span className="text-[#8B0000]">Protocols</span>.
                        </h2>
                        <p className="text-gray-500 text-xl max-w-2xl mx-auto leading-relaxed">
                            Select the evidence-based regimen that aligns with your clinical objectives and cardiovascular health goals.
                        </p>
                    </div>
                        ...
                        {packages.map((pkg) => (
                            <div 
                                ...
                                className={`relative group rounded-[60px] p-12 lg:p-16 transition-all duration-700 bg-white border-2 hover:shadow-[0_40px_100px_rgba(0,0,0,0.1)] ${
                                    pkg.popular ? 'border-[#8B0000] scale-105 z-10' : 'border-gray-50 hover:border-[#D4AF37]/30'
                                }`}
                            >
                                {pkg.popular && (
                                ...
                                <div className="mb-16">
                                    ...
                                    <div className="flex items-center gap-3">
                                        <span className="text-xs font-black text-gray-400 uppercase tracking-[0.2em]">{pkg.duration}</span>
                                        {pkg.savings && (
                                ...
                                <div className="mb-16 flex items-baseline gap-2">
                                    ...
                                    <span className="text-7xl lg:text-8xl font-black text-gray-900 tracking-tighter leading-none">{pkg.price}</span>
                                </div>
                    ...
                    <div className="mt-32 grid grid-cols-2 lg:grid-cols-4 gap-12 pt-24 border-t border-gray-100">
                        <div className="flex flex-col items-center gap-6 text-center group">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900">Priority Logistics</span>
                        </div>
                        <div className="flex flex-col items-center gap-6 text-center group">
                            ...
                            <span className="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900">Secure Protocol</span>
                        </div>
                        <div className="flex flex-col items-center gap-6 text-center group">
                            <div className="w-16 h-16 rounded-[24px] bg-gray-50 flex items-center justify-center text-gray-400 group-hover:text-[#D4AF37] group-hover:bg-[#D4AF37]/5 transition-all duration-500 group-hover:scale-110">
                                <Package className="w-8 h-8" />
                            </div>
                            <span className="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900">Direct Procurement</span>
                        </div>
                        <div className="flex flex-col items-center gap-6 text-center group">
                            <div className="w-16 h-16 rounded-[24px] bg-gray-50 flex items-center justify-center text-gray-400 group-hover:text-[#8B0000] group-hover:bg-[#8B0000]/5 transition-all duration-500 group-hover:scale-110">
                                <Headphones className="w-8 h-8" />
                            </div>
                            <span className="text-[11px] font-black uppercase tracking-[0.3em] text-gray-900">Adherence Support</span>
                        </div>
                    </div>
                </div>
            </div>
