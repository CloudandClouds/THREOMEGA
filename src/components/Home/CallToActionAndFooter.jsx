            ...
            <div className="max-w-4xl mx-auto text-center">
              <div className="inline-flex items-center gap-3 px-6 py-2 rounded-full bg-white/10 border border-white/20 mb-10 backdrop-blur-md">
                ...
                <span className="text-white font-bold tracking-[0.2em] text-[10px] uppercase">
                  Immediate Clinical Protection
                </span>
              </div>

              <h2
                className="text-5xl md:text-8xl font-black text-white mb-10 leading-[0.9]"
              ...
              <p className="text-white/70 text-xl md:text-2xl mb-16 max-w-2xl mx-auto font-medium italic">
                "Join 2,500+ patients who have integrated clinical-grade Omega-3 into their daily
                dialysis regimen."
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                ...
                <button className="group px-10 py-6 bg-[#D4AF37] text-gray-900 font-black rounded-3xl transition-all hover:bg-[#B8860B] hover:scale-105 shadow-2xl">
                  CLINICAL CENTERS
                  <span className="block text-black/40 font-bold uppercase tracking-widest mt-1 text-[10px]">
                    Partner In Care
                  </span>
                </button>
              </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-16 mb-24">
              ...
              <div className="md:col-span-8 grid grid-cols-2 lg:grid-cols-3 gap-12">
                <div>
                  <h4 className="text-white font-bold tracking-widest text-xs uppercase mb-8">
                    Clinical Access
                  </h4>
                  <ul className="space-y-4">
                    {quickLinks.map((link, i) => (
                      <li key={i}>
                        <a
                          href={link.href}
                          className="text-white/40 hover:text-[#D4AF37] transition-colors text-sm font-medium flex items-center gap-2 group"
                        >
                          {link.name}
                  ...
                  <ul className="space-y-4">
                    {resources.map((link, i) => (
                      <li key={i}>
                        <a
                          href={link.href}
                          className="text-white/40 hover:text-[#D4AF37] transition-colors text-sm font-medium"
                        >
                          {link.name}
                        </a>
                      </li>
            ...
            <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
              <div className="flex flex-col md:flex-row items-center gap-8 text-center md:text-left">
                <p className="text-white/20 text-xs">
                  © 2026 Ponoogun™ Health. All rights reserved.
                </p>
            ...
            <div className="mt-12 text-center max-w-4xl mx-auto">
              <p className="text-[10px] text-white/10 font-bold leading-relaxed uppercase tracking-tighter">
                DISCLAIMER: THREOMEGA™ - CV IS A DIETARY SUPPLEMENT INTENDED TO PROVIDE MEDICAL
                NUTRITIONAL SUPPORT. IT IS NOT INTENDED TO DIAGNOSE, TREAT, CURE, OR PREVENT ANY
                DISEASE. ALWAYS CONSULT YOUR NEPHROLOGIST BEFORE MODIFYING YOUR CLINICAL REGIMEN.
                RESULTS OF THE PISCES-HD TRIAL REPRESENT GENERAL PATIENT COHORTS AND INDIVIDUAL
                OUTCOMES MAY VARY.
              </p>
            </div>
          </div>
