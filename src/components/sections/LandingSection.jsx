  ...
  return (
    <div className="min-h-screen bg-white relative overflow-hidden flex flex-col justify-center items-center p-6 text-gray-900">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-[500px] h-[500px] bg-[#D4AF37] rounded-full mix-blend-multiply filter blur-[120px] opacity-[0.08] animate-pulse"></div>
        <div className="absolute bottom-[-10%] left-[-10%] w-[500px] h-[500px] bg-[#8B0000] rounded-full mix-blend-multiply filter blur-[120px] opacity-[0.08] animate-pulse" style={{animationDelay: '1s'}}></div>
      </div>
      ...
      <div className="relative z-10 max-w-2xl w-full">
        ...
        <div className="mb-12 text-center animate-fade-in">
          ...
          <h1 className="text-6xl font-bold bg-gradient-to-r from-[#D4AF37] via-[#B8860B] to-[#8B0000] bg-clip-text text-transparent mb-4" style={{fontFamily: 'serif'}}>
            PONOOGUN
          </h1>
          <p className="text-gray-600 text-sm tracking-widest uppercase mb-8">Advancing Nephrology Care Through Innovation</p>
        </div>

        {/* Main Content Card */}
        <div className="bg-white border-2 border-gray-200 rounded-3xl p-8 lg:p-10 shadow-xl animate-slide-up">
          <h2 className="text-3xl font-bold text-gray-900 mb-4" style={{fontFamily: 'serif'}}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 rounded-lg bg-white border-2 border-gray-200 flex items-center justify-center shadow-sm">
                <ShieldCheck className="w-5 h-5 text-[#D4AF37]" />
              </div>
              <div>
                <span className="block text-gray-900 text-sm font-semibold">Evidence Based</span>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                <span className="block text-gray-900 text-sm font-semibold">Quick Session</span>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 flex items-center justify-center gap-3 text-gray-600">
