...
const RegistrationSection = ({ formData, setFormData, onSubmit, onNext }) => {
  ...
  const inputClasses =
    'w-full px-5 py-4 bg-white border-2 border-gray-300 rounded-xl focus:border-[#D4AF37] focus:outline-none transition-all text-gray-900 placeholder-gray-400'
  const labelClasses =
    'block text-[10px] uppercase tracking-[0.2em] font-bold text-gray-600 mb-3 flex items-center gap-2'

  return (
    <div className="min-h-screen bg-white py-12 px-6 text-gray-900 relative overflow-hidden">
      {/* Background Decorative Element */}
      <div className="fixed top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[10%] left-[-5%] w-[400px] h-[400px] bg-[#8B0000] rounded-full mix-blend-multiply filter blur-[150px] opacity-[0.05]"></div>
        <div className="absolute bottom-[10%] right-[-5%] w-[400px] h-[400px] bg-[#D4AF37] rounded-full mix-blend-multiply filter blur-[150px] opacity-[0.05]"></div>
      </div>

      <div className="max-w-2xl mx-auto relative z-10 animate-fade-in">
        <div className="text-center mb-10">
          <div className="inline-block px-4 py-1.5 rounded-full bg-[#D4AF37]/10 border-2 border-[#D4AF37]/30 mb-6">
            <span className="text-[10px] uppercase tracking-[0.2em] font-bold text-[#D4AF37]">
              Appreciation Draw Registration
            </span>
          </div>
          <h1 className="text-4xl font-bold text-gray-900 mb-3" style={{ fontFamily: 'serif' }}>
        ...
        <form
          ...
          className="bg-white border-2 border-gray-200 rounded-3xl p-8 lg:p-12 space-y-8 shadow-xl"
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="md:col-span-2">
              ...
              >
                ...
                <option value="md-nephro" className="bg-white">
                  MD/DNB Nephrology
                </option>
                <option value="dm-nephro" className="bg-white">
                  DM Nephrology
                </option>
                <option value="md-medicine" className="bg-white">
                  MD Medicine
                </option>
            ...
            <label className="flex items-start gap-4 cursor-pointer group">
              <div className="relative flex items-center mt-1">
                <input
                  ...
                  className="w-5 h-5 rounded border-gray-300 bg-white text-[#D4AF37] focus:ring-[#D4AF37] transition-all cursor-pointer"
                />
              </div>
          ...
          <div className="pt-8 border-t border-gray-200">
            <p className="text-[10px] uppercase tracking-[0.2em] font-bold text-gray-600 mb-6">
            ...
            <div className="flex flex-wrap gap-4">
              {['Conference/Equipment', 'Research Grant', 'No preference'].map((pref) => (
                <label
                  key={pref}
                  className={`flex-1 min-w-[140px] flex items-center gap-3 cursor-pointer p-4 rounded-xl border-2 transition-all ${
                    formData.prizePreference === pref
                      ? 'border-[#D4AF37] bg-[#D4AF37]/5 text-gray-900 shadow-sm'
