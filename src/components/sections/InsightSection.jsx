  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-6 text-gray-900 overflow-hidden relative">
      ...
      <div className="max-w-xl w-full relative z-10 flex-1 flex flex-col justify-center">
        ...
        <div className="bg-white border-2 border-gray-200 rounded-3xl p-10 mb-10 shadow-xl relative overflow-hidden group">
          <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
            <Lightbulb className="w-24 h-24 text-[#D4AF37]" />
          </div>
          <p
            className="text-2xl mb-8 leading-relaxed font-medium text-gray-900 relative z-10"
            style={{ fontFamily: 'serif' }}
          >
            The PISCES trial demonstrated a <span className="text-[#D4AF37] font-bold">43% reduction</span> in
            serious cardiovascular events using{' '}
            <span className="underline decoration-[#8B0000] underline-offset-4 font-semibold">
              EPA 1.6g + DHA 0.8g
            </span>{' '}
        ...
        <button
          onClick={onNext}
          className="w-full bg-[#8B0000] hover:bg-[#A50000] text-white font-bold py-5 rounded-2xl transition-all duration-300 transform hover:scale-[1.02] flex items-center justify-center gap-2 shadow-lg hover:shadow-xl group mb-4"
        >
          CONTINUE
