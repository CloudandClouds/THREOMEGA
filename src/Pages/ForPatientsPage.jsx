          ...
          <div className="max-w-7xl mx-auto relative z-10 text-center">
            <div className="inline-flex items-center gap-2 mb-6">
              ...
              <span className="text-[#8B0000] font-bold tracking-widest text-xs uppercase">
                Trusted by Nephrologists & Dialysis Centers
              </span>
              <div className="h-[1px] w-8 bg-[#8B0000]"></div>
            </div>
            <h1
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto mt-16">
              {[
                { icon: <Heart className="w-8 h-8" />, text: 'Helps reduce cardiovascular risk' },
                {
                  ...
                  text: 'Supports heart health in dialysis patients',
                },
                ...
                {[
                  {
                    ...
                    desc: 'Persistent inflammatory markers',
                  },
                  {
                    icon: <TrendingDown className="w-10 h-10" />,
                    title: 'Oxidative stress',
                    desc: 'Increased cellular damage',
                  },
                  {
                    icon: <Droplet className="w-10 h-10" />,
                    title: 'Altered lipid metabolism',
                    desc: 'Abnormal cholesterol processing',
                  },
                ].map((item, i) => (
              ...
              {[
                {
                  ...
                  desc: 'Helps lower markers linked to heart disease',
                },
                {
                  icon: <Activity className="w-8 h-8" />,
                  title: 'Improved Lipid Profile',
                  desc: 'Supports healthier cholesterol levels',
                },
                {
                  icon: <Heart className="w-8 h-8" />,
                  title: 'Better Cardiovascular Outcomes',
                  desc: 'Reduced cardiac risk in dialysis patients',
                },
                {
                  icon: <Shield className="w-8 h-8" />,
                  title: 'Well Tolerated',
                  desc: 'Safe and suitable for long-term use',
                },
              ].map((item, i) => (
                <div
                  key={i}
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-gray-700 font-medium mb-2">
                          As prescribed by your nephrologist
                        </p>
                ...
                {submitted ? (
                  <div className="text-center py-20 animate-scale-in">
                    ...
                    <p className="text-gray-500">
                      Thank you for reaching out. A wellness consultant will contact you shortly to
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        <label className={labelClasses}>
                          <Droplet className="w-3.5 h-3.5" /> Dialysis Type
                        </label>
                        <select
                      ...
                      <div>
                        <label className={labelClasses}>
                          <Clock className="w-3.5 h-3.5" /> Duration on Dialysis
                        </label>
                        <input
                          type="text"
                          ...
                          onChange={(e) =>
                            setFormData({ ...formData, dialysisDuration: e.target.value })
                          }
                          className={inputClasses}
                          required
                        />
                      ...
                      <div className="md:col-span-2">
                        <label className={labelClasses}>
                          <Heart className="w-3.5 h-3.5" /> Existing Heart Conditions
                        </label>
                        <textarea
                          rows="3"
                          ...
                          onChange={(e) =>
                            setFormData({ ...formData, heartConditions: e.target.value })
                          }
                          className={inputClasses + ' resize-none'}
                        ></textarea>
                      </div>
