            ...
            <div className="relative pt-32 pb-20 px-6 overflow-hidden bg-gradient-to-br from-gray-100 via-gray-50 to-white">
                <div className="max-w-7xl mx-auto relative z-10 text-center">
                    <div className="inline-flex items-center gap-2 mb-6">
                        ...
                        <span className="text-[#D4AF37] font-bold tracking-widest text-xs uppercase">For Healthcare Professionals</span>
                        <div className="h-[1px] w-8 bg-[#D4AF37]"></div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-5xl mx-auto mt-16">
                        {[
                            ...
                            <div key={i} className="bg-white rounded-3xl p-6 shadow-lg border-2 border-gray-100 hover:shadow-xl transition-all hover:-translate-y-1">
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="text-center mb-16">
                        <div className="inline-flex items-center gap-2 mb-6">
                            ...
                            <span className="text-[#8B0000] font-bold tracking-widest text-xs uppercase">Landmark Clinical Trial</span>
                            <div className="h-[1px] w-8 bg-[#8B0000]"></div>
                        </div>
                        ...
                        <p className="text-gray-600 text-xl max-w-2xl mx-auto">
                            Randomized, double-blind trial demonstrating cardiovascular benefits in hemodialysis patients
                        </p>
                    </div>
                    ...
                    <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-10 md:p-16 border-2 border-[#D4AF37]/10 shadow-lg">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            {[
                                { icon: <Users className="w-10 h-10" />, title: "206 Patients", desc: "Multi-center recruitment" },
                                { icon: <Calendar className="w-10 h-10" />, title: "12 Months", desc: "Double-blind intervention period" },
                                { icon: <Heart className="w-10 h-10" />, title: "Primary Endpoint", desc: "Cardiovascular mortality reduction" },
                                { icon: <Activity className="w-10 h-10" />, title: "Secondary Outcomes", desc: "Inflammatory markers & lipid profiles" }
                            ].map((item, i) => (
                            ...
                            <div className="space-y-6">
                                <div className="flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 text-sm">Monitor at baseline and every 3 months</p>
                                    </div>
                                </div>
